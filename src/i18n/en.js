...
export default {
  ...
  ui: {
    ...
    esquemaInstrucoes: 'Click a block to open its card. Moving arrows show the flow of this scenario.',
    esquemaExplorarFluxo: 'Explore the flow',
    esquemaPausarFluxo: 'Pause the flow',
    esquemaVerPortefolio: 'View portfolio',
    esquemaRodape: 'Moving arrows = flow of this scenario. Click a block for detail. Map = full portfolio.',
    northStarTitulo: 'North Star — four layers',
    viewNeeds: 'Needs',
    necSituacao: 'Your situation',
    necSituacaoAjuda: 'Pick what most resembles your company. Then adjust.',
    necCapacidades: 'What you need to do',
    necCapacidadesAjuda: 'In business language, not product language.',
    necLandscape: 'What you need to buy',
    necTotalPecas: '{n} pieces',
    necVia: 'Contract route:',
    necVia_cloud: 'GROW (public cloud)',
    necVia_rise: 'RISE (private)',
    necVia_onprem: 'On-premise',
    necPessoas: 'People:',
    necJaTemSap: 'Already runs SAP',
    necMuitoCodigo: 'with heavy custom code',
    necClasse_base: 'base',
    necClasse_nucleo: 'essential',
    necClasse_conformidade: 'required in PT',
    necClasse_apoio: 'chosen',
    necClasse_dependencia: 'dependency',
    necClasse_extra: 'transformation',
    necPerguntas: 'Questions that change the recommendation',
    necPerguntasAjuda: 'Switch on only what is true for your company.',
    necDecisoes: 'Decisions and honest warnings',
    necEmpregados: 'What to give your employees',
    necEmpregadosAjuda: 'By job: the apps each person opens day to day.',
    necAppsBloqueadas: 'Only with more pieces',
    necRequer: 'needs {s} in the landscape',
    necRodape: 'Standard S/4HANA Cloud Fiori app names. Confirm the exact app ID and business role in the SAP Fiori Apps Reference Library for the release you contract.',
    viewBuilder: 'Builder',
    builderTitle: 'Landscape under construction',
    builderSearch: 'Find a piece...',
    builderAll: 'All',
    builderDragHint: 'Drag onto the right layer, or double-click to place.',
    builderAdd: 'Add',
    builderRemove: 'Remove',
    builderPaletteEmpty: 'Nothing found in this layer.',
    builderPieces: 'pieces',
    builderLinks: 'links',
    builderLayers: 'layers',
    builderTemplates: 'Reference architectures',
    builderTemplatesHint: 'Start from an architecture SAP published, then change it.',
    builderExport: 'Export',
    builderClear: 'Clear',
    builderWrongLayer: 'Wrong layer — this piece is',
    builderEmptyLayer: 'empty',
    builderSuggestions: 'Suggestions',
    builderSuggestionsHint: 'Ranked by how many official SAP diagrams draw these next to yours.',
    builderInDiagrams: 'SAP diagrams',
    builderNoSuggestions: 'Place a piece to get suggestions.',
    builderChecks: 'Checks',
    builderAllGood: 'No problems detected.',
    builderConnections: 'Links for this piece',
    builderSearch: 'Find a piece to add',
    builderAllLayers: 'All',
    builderAdd: 'Add',
    builderRemove: 'Remove',
    builderClear: 'Clear all',
    builderPieces: 'pieces',
    builderDropHere: 'drag a piece from this layer here',
    builderEmpty: 'Drag pieces from the palette onto the layers, or load a typical mix to start from an assembled landscape.',
    builderTemplates: 'Start from a typical mix',
    builderValidator: 'Validation',
    builderSuggestions: 'Missing pieces',
    builderAllGood: 'Coherent landscape: every piece exists in this scenario and sits on something.',
    builderNotInScenario: 'outside this scenario',
    ruleScenario: 'does not exist in this scenario. Switch preset or remove the piece.',
    ruleNoInfra: 'has no infrastructure underneath. Add an L0 piece.',
    ruleNoFoundation: 'is sitting on nothing — none of the layers it depends on have been placed.',
    ruleLegacy: 'is legacy being phased out in this scenario — legitimate during the transition, but it has an end date.',
    ruleIsolated: 'does not connect to any other piece in your landscape.',
    builderDisclaimer: 'Validation comes from the catalogue itself: layer (what sits on what), scenarios (whether the piece exists in this preset) and ligaA (dependencies). This is not an SAP licensing configurator.',
    profiles: {
