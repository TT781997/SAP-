...
export const services: Record<string, ServiceCopy> = {
  "aws": {
    ...
    "nesteCenario": {
      "onprem": "Is not the host of the ERP. Pode existir como cloud satellite da empresa without fazer parte do core SAP. Tarjeta atenuada.",
  ...
  "gcp": {
    ...
    "nesteCenario": {
      "onprem": "No es el anfitrión del ERP. Tarjeta atenuada.",
  ...
  "dc-onprem": {
    ...
    "nesteCenario": {
      "onprem": "Tarjeta fundación L0. Todo el núcleo descansa aquí.",
  ...
  "cdc-option": {
    ...
    "nesteCenario": {
      "onprem": "No aplica. On-prem clássico is not CDC.",
      "cloud": "No aplica. GROW Public Edition não tem opção CDC.",
  ...
  "hana-onprem": {
    ...
    "nesteCenario": {
      "onprem": "Core database. Tarjeta activa.",
  ...
  "hana-cloud": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Active. Persistence for extensions and GROW analytics.",
      "rise": "Active. Os BTP credits do RISE cover typical usage. Do not confuse with the managed HANA under the S/4 Private Edition."
    }
  },
  "datasphere": {
    "nome": "SAP Datasphere",
    ...
    "nesteCenario": {
      "onprem": "Dimmed. Can consume on-prem HANA/BW via DP Agent, but is not the classic default.",
      "cloud": "Active. Strategic data warehouse / fabric of Public Cloud.",
      "rise": "Active. Piece of Business Data Cloud e da analytics path of the RISE landscape."
    },
  ...
  "bdc": {
    ...
    "nesteCenario": {
      ...
      "rise": "Active. Context layer para Joule e agentes no landscape RISE."
    }
  },
  "bw4": {
    "nome": "SAP BW/4HANA",
    ...
    "nesteCenario": {
      "onprem": "Default warehouse if the customer is already classic SAP analytics. Active.",
      "cloud": "Dimmed. Strategic target = Datasphere. BW Bridge is the bridge, not the destination.",
  ...
  "businessobjects": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Oculto / legacy. New reporting is born in SAC.",
  ...
  "bpc": {
    ...
    "nesteCenario": {
      "onprem": "Activo con el conmutador de legado.",
      "cloud": "Oculto. Target = SAC.",
      "rise": "Legado. Visible con el conmutador."
    }
  },
  "analysis-office": {
  ...
  "data-services": {
    ...
    "nesteCenario": {
      ...
      "rise": "Legacy. Visible con el conmutador. Plano típico: phase-out to Datasphere + Suite."
    }
  },
  "data-intelligence": {
    ...
    "nesteCenario": {
      ...
      "rise": "Dimmed. Coexistência possível durante a transição."
    }
  },
  "ilm": {
  ...
  "btp": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Active. GROW extension and integration platform. Without BTP, Public Edition cannot be extended in an upgrade-safe way.",
  ...
  "build": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Active. Ferramenta de extension do Public Edition.",
      "rise": "Active. Destino preferencial do custom code que o Cloud ALM classifica fora do core."
    }
  },
  "workzone": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Active. GROW UX shell.",
      "rise": "Active. Recommended entry point of the hybrid landscape."
    }
  },
  "ias": {
    ...
    "nesteCenario": {
      "onprem": "Dimmed. Only joins if cloud islands already exist.",
      "cloud": "Active. Public Edition suite IdP.",
  ...
  "abap-env": {
    ...
    "nesteCenario": {
      ...
      "rise": "Active. One of the three strategic BTP runtimes in RISE."
    }
  },
  "runtimes-btp": {
    ...
    "nesteCenario": {
      ...
      "rise": "Active. CF default; Kyma when the industry profile or microservice volume justifies it."
    }
  },
  "ai-foundation": {
    ...
    "nesteCenario": {
      "onprem": "No aplica en la mezcla por defecto.",
      "cloud": "Active in the GROW AI stack.",
      "rise": "Active. Foundation of the Joule assistants contractually included in RISE year 1."
    }
  },
  "iag": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Recomendado con el perfil regulado.",
      "rise": "Recomendado con el perfil regulado."
    }
  },
  "sap-start": {
  ...
  "integration-suite": {
    ...
    "nesteCenario": {
      "onprem": "Dimmed. Default middleware is PI/PO; the Suite may already exist as a migration island.",
      "cloud": "Active. GROW iPaaS / Public Edition.",
      "rise": "Active. Baseline included in RISE. Cloud ALM monitors iFlows. Official PI/PO migration target."
    }
  },
  "event-mesh": {
    "nome": "SAP Event Mesh",
  ...
  "cloud-connector": {
    ...
    "nesteCenario": {
      "onprem": "Ausente en on-prem puro.",
      "cloud": "Optional. Active if on-prem satellites remain.",
  ...
  "pipo": {
    ...
    "nesteCenario": {
      "onprem": "Default middleware. Tarjeta activa.",
      "cloud": "Oculto.",
  ...
  "managed-gateway": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Activo con el perfil spend.",
      "rise": "Activo con el perfil spend."
    }
  },
  "multi-bank": {
  ...
  "snc": {
    ...
    "tipo": "Colaboración con proveedores",
  ...
  "ecc": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Oculto. GROW is greenfield Public Edition, not ECC in the cloud.",
  ...
  "s4-any": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Oculto. Replaced by S/4HANA Cloud Public Edition.",
  ...
  "s4hana": {
    ...
    "nesteCenario": {
      "onprem": "Oculto. The active L4 card is s4-any ou ecc.",
  ...
  "cash-application": {
    ...
    "nesteCenario": {
      "onprem": "Atenuado.",
      "cloud": "Opcional Finanzas.",
      "rise": "Opcional Finanzas."
    }
  },
  "rar": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Opcional.",
      "rise": "Opcional con el perfil regulado."
    }
  },
  ...
  "ppm": {
    ...
    "nesteCenario": {
      ...
      "rise": "Opcional con el perfil industria."
    }
  },
  "business-one": {
  ...
  "successfactors": {
    ...
    "nesteCenario": {
      "onprem": "Dimmed. The classic default is SAP HCM on ECC/S/4.",
      "cloud": "Active. GROW HCM.",
      "rise": "Activo."
    }
  },
  "hcm-onprem": {
    ...
    "nesteCenario": {
      "onprem": "Activo.",
      "cloud": "Oculto / legado.",
      "rise": "Dimmed. Residual on-prem payroll is a real RISE mix pattern."
    }
  },
  "ariba": {
    "nome": "SAP Ariba",
  ...
  "business-network": {
    ...
    "nesteCenario": {
      "onprem": "Atenuado.",
      "cloud": "Activo con el perfil spend.",
      "rise": "Active. A starter pack usually comes in the RISE envelope."
    }
  },
  "concur": {
    "nome": "SAP Concur",
    "tipo": "SaaS viajes y gastos",
  ...
  "taulia": {
    ...
    "nesteCenario": {
      "onprem": "Atenuado.",
      "cloud": "Opcional con el perfil spend.",
      "rise": "Opcional con el perfil spend."
    }
  },
  "spend-control-tower": {
    "nome": "SAP Spend Control Tower",
    "tipo": "Analítica de gasto",
  ...
  "signavio": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Active. GROW fit-to-standard.",
      "rise": "Active. Process toolchain of the RISE methodology."
    }
  },
  "sac": {
    "nome": "SAP Analytics Cloud",
    "tipo": "Analítica + planificación",
  ...
  "ibp": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Optional. Recommended con el perfil industria.",
      "rise": "Optional. Recommended con el perfil industria."
    }
  },
  "ewm": {
    "nome": "SAP EWM",
  ...
  "digital-manufacturing": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Opcional con el perfil industria.",
      "rise": "Recomendado con el perfil industria."
    }
  },
  "apm": {
  ...
  "sustainability": {
    ...
    "nesteCenario": {
      "onprem": "Atenuado.",
      "cloud": "Opcional con el perfil regulado.",
  ...
  "document-compliance": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Active. Peça do GROW honest minimum.",
      "rise": "Activo."
    }
  },
  "brim": {
  ...
  "cloud-alm": {
    ...
    "nesteCenario": {
      "onprem": "Disponível se houver Enterprise Support, mas the default é Solution Manager. Tarjeta atenuada.",
  ...
  "dwc": {
    ...
    "nesteCenario": {
      "onprem": "Dimmed. On-prem clássico deploys com SolMan/ChaRM — o contrário cultural do DwC.",
  ...
  "btc": {
    ...
    "nesteCenario": {
      ...
      "rise": "Recomendado con el perfil brownfield."
    }
  },
  "tricentis": {
  ...
  "sci": {
    ...
    "nesteCenario": {
      "onprem": "Not applicable como host of the ERP on-prem. Tarjeta atenuada.",
  ...
  "cloud-erp": {
    ...
    "nesteCenario": {
      "onprem": "No aplica.",
      "cloud": "Active. Sinónimo comercial do Public Edition.",
      "rise": "Active. Sinónimo comercial do Private Edition / RISE Cloud ERP."
    },
