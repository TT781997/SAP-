...
export const services: Record<string, ServiceCopy> = {
  "aws": {
    ...
    "nesteCenario": {
      "onprem": "Is not the host of the ERP. Pode existir como cloud satellite da empresa without fazer parte do core SAP. Abgeschwächte Karte.",
  ...
  "gcp": {
    ...
    "nesteCenario": {
      "onprem": "Nicht der ERP-Host. Abgeschwächte Karte.",
  ...
  "dc-onprem": {
    ...
    "nesteCenario": {
      "onprem": "L0-Fundament. Der gesamte Kern sitzt hier.",
  ...
  "cdc-option": {
    ...
    "nesteCenario": {
      "onprem": "Nicht zutreffend. On-prem clássico is not CDC.",
      "cloud": "Nicht zutreffend. GROW Public Edition não tem opção CDC.",
      "rise": "Optional. Active e recommended só com o regulated profile."
    },
  ...
  "hana-onprem": {
    ...
    "nesteCenario": {
      "onprem": "Core database. Aktive Karte.",
  ...
  "hana-cloud": {
    ...
    "nesteCenario": {
      "onprem": "Abwesend. The equivalent is HANA on-prem.",
      "cloud": "Aktiv. Persistence for extensions and GROW analytics.",
      "rise": "Aktiv. Os BTP credits do RISE cover typical usage. Do not confuse with the managed HANA under the S/4 Private Edition."
    }
  },
  "datasphere": {
    "nome": "SAP Datasphere",
    ...
    "nesteCenario": {
      "onprem": "Abgeschwächt. Can consume on-prem HANA/BW via DP Agent, but is not the classic default.",
      "cloud": "Aktiv. Strategic data warehouse / fabric of Public Cloud.",
      "rise": "Aktiv. Piece of Business Data Cloud e da analytics path of the RISE landscape."
    },
  ...
  "bdc": {
    ...
    "nesteCenario": {
      ...
      "rise": "Aktiv. Context layer para Joule e agentes no landscape RISE."
    }
  },
  "bw4": {
    "nome": "SAP BW/4HANA",
    ...
    "nesteCenario": {
      "onprem": "Default warehouse if the customer is already classic SAP analytics. Aktiv.",
      "cloud": "Abgeschwächt. Strategic target = Datasphere. BW Bridge is the bridge, not the destination.",
  ...
  "businessobjects": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Ausgeblendet / Legacy. New reporting is born in SAC.",
      "rise": "Legacy. Visible com o toggle. Typical plan: coexistence and phase-out to SAC."
    }
  },
  "papm": {
    "nome": "SAP PaPM",
  ...
  "bpc": {
    ...
    "nesteCenario": {
      "onprem": "Aktiv mit Legacy-Schalter.",
      "cloud": "Ausgeblendet. Target = SAC.",
      "rise": "Legacy. Sichtbar mit Schalter."
    }
  },
  "analysis-office": {
  ...
  "data-services": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Abgeschwächt. New pipelines are born in Datasphere / Integration Suite.",
      "rise": "Legacy. Sichtbar mit Schalter. Plano típico: phase-out to Datasphere + Suite."
    }
  },
  "data-intelligence": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Abgeschwächt. Target = Datasphere + BDC.",
      "rise": "Abgeschwächt. Coexistência possível durante a transição."
    }
  },
  "ilm": {
    "nome": "SAP Information Lifecycle Management",
    "tipo": "Archiv / Aufbewahrung",
  ...
  "btp": {
    ...
    "nesteCenario": {
      "onprem": "Abgeschwächt. May exist as an innovation island without being the landscape default.",
      "cloud": "Aktiv. GROW extension and integration platform. Without BTP, Public Edition cannot be extended in an upgrade-safe way.",
  ...
  "build": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Aktiv. Ferramenta de extension do Public Edition.",
      "rise": "Aktiv. Destino preferencial do custom code que o Cloud ALM classifica fora do core."
    }
  },
  "workzone": {
    ...
    "nesteCenario": {
      "onprem": "Abgeschwächt. The classic equivalent is Fiori Launchpad / Enterprise Portal in the DC.",
      "cloud": "Aktiv. GROW UX shell.",
      "rise": "Aktiv. Recommended entry point of the hybrid landscape."
    }
  },
  "ias": {
    ...
    "nesteCenario": {
      "onprem": "Abgeschwächt. Only joins if cloud islands already exist.",
      "cloud": "Aktiv. Public Edition suite IdP.",
      "rise": "Aktiv. Identity for S/4 Private Edition + BTP + LoB."
    }
  },
  "abap-env": {
    ...
    "nesteCenario": {
      "onprem": "Abwesend. ABAP lives on NetWeaver / S/4 any-premise.",
      "cloud": "Active as Public Edition extension runtime.",
      "rise": "Aktiv. One of the three strategic BTP runtimes in RISE."
    }
  },
  "runtimes-btp": {
    ...
    "nesteCenario": {
      "onprem": "Abwesend.",
      "cloud": "Aktiv. CF is the default for GROW extensions.",
      "rise": "Aktiv. CF default; Kyma when the industry profile or microservice volume justifies it."
    }
  },
  "ai-foundation": {
    ...
    "nesteCenario": {
      "onprem": "Im Standardmix nicht zutreffend.",
      "cloud": "Active in the GROW AI stack.",
      "rise": "Aktiv. Foundation of the Joule assistants contractually included in RISE year 1."
    }
  },
  "iag": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Empfohlen mit Profil Reguliert.",
      "rise": "Empfohlen mit Profil Reguliert."
    }
  },
  "sap-start": {
  ...
  "enterprise-portal": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Ausgeblendet.",
      "rise": "Ausgeblendet / Legacy."
    }
  },
  "lama": {
    "nome": "SAP Landscape Management",
    "tipo": "Landschaftsbetrieb",
  ...
  "integration-suite": {
    ...
    "nesteCenario": {
      "onprem": "Abgeschwächt. Default middleware is PI/PO; the Suite may already exist as a migration island.",
      "cloud": "Aktiv. GROW iPaaS / Public Edition.",
      "rise": "Aktiv. Baseline included in RISE. Cloud ALM monitors iFlows. Official PI/PO migration target."
    }
  },
  "event-mesh": {
    "nome": "SAP Event Mesh",
    ...
    "nesteCenario": {
      ...
      "cloud": "Aktiv. Public Edition decoupling pattern.",
      "rise": "Aktiv. Private Edition business events consumed by BTP extensions."
    }
  },
  "advanced-event-mesh": {
  ...
  "cloud-connector": {
    ...
    "nesteCenario": {
      "onprem": "Im reinen On-Prem abwesend.",
      "cloud": "Optional. Active se restarem satellites on-prem.",
  ...
  "pipo": {
    ...
    "nesteCenario": {
      "onprem": "Default middleware. Aktive Karte.",
      "cloud": "Ausgeblendet.",
  ...
  "managed-gateway": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Aktiv mit Profil Spend.",
      "rise": "Aktiv mit Profil Spend."
    }
  },
  "multi-bank": {
  ...
  "snc": {
    ...
    "tipo": "Lieferantenzusammenarbeit",
    ...
    "nesteCenario": {
      ...
      "cloud": "Abgeschwächt. Target = Business Network.",
      "rise": "Optional. Coexistence or migration to the Network."
    }
  },
  "ecc": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Ausgeblendet. GROW is greenfield Public Edition, not ECC in the cloud.",
  ...
  "s4-any": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Ausgeblendet. Replaced by S/4HANA Cloud Public Edition.",
  ...
  "s4hana": {
    ...
    "nesteCenario": {
      "onprem": "Ausgeblendet. The active L4 card is s4-any ou ecc.",
  ...
  "cash-application": {
    ...
    "nesteCenario": {
      "onprem": "Abgeschwächt.",
      "cloud": "Optional für Finance.",
      "rise": "Optional für Finance."
    }
  },
  "rar": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Optional.",
      "rise": "Optional mit Profil Reguliert."
    }
  },
  ...
  "ppm": {
    ...
    "nesteCenario": {
      ...
      "rise": "Optional mit Profil Industrie."
    }
  },
  "business-one": {
  ...
  "bydesign": {
    ...
    "nesteCenario": {
      "onprem": "Nicht zutreffend.",
      "cloud": "Optional. Is not the default GROW.",
  ...
  "successfactors": {
    ...
    "nesteCenario": {
      "onprem": "Abgeschwächt. The classic default is SAP HCM on ECC/S/4.",
      "cloud": "Aktiv. GROW HCM.",
      "rise": "Aktiv."
    }
  },
  "hcm-onprem": {
    ...
    "nesteCenario": {
      "onprem": "Aktiv.",
      "cloud": "Ausgeblendet / Legacy.",
      "rise": "Abgeschwächt. Residual on-prem payroll is a real RISE mix pattern."
    }
  },
  "ariba": {
    "nome": "SAP Ariba",
    "tipo": "SaaS Beschaffung",
  ...
  "business-network": {
    ...
    "nesteCenario": {
      "onprem": "Abgeschwächt.",
      "cloud": "Aktiv mit Profil Spend.",
      "rise": "Aktiv. A starter pack usually comes in the RISE envelope."
    }
  },
  "concur": {
    "nome": "SAP Concur",
    "tipo": "SaaS Reisekosten",
  ...
  "taulia": {
    ...
    "nesteCenario": {
      "onprem": "Abgeschwächt.",
      "cloud": "Optional mit Profil Spend.",
      "rise": "Optional mit Profil Spend."
    }
  },
  "spend-control-tower": {
  ...
  "vim": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Abgeschwächt. Target = Ariba Invoice / CIM.",
      "rise": "Optional. Many RISE landscapes keep VIM on Private Edition."
    }
  },
  "signavio": {
    "nome": "SAP Signavio",
    ...
    "nesteCenario": {
      ...
      "cloud": "Aktiv. GROW fit-to-standard.",
      "rise": "Aktiv. Process toolchain of the RISE methodology."
    }
  },
  "sac": {
    "nome": "SAP Analytics Cloud",
    "tipo": "Analytics + Planung",
  ...
  "ibp": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Optional. Empfohlen mit Profil Industrie.",
      "rise": "Optional. Empfohlen mit Profil Industrie."
    }
  },
  "ewm": {
    "nome": "SAP EWM",
  ...
  "digital-manufacturing": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Optional mit Profil Industrie.",
      "rise": "Empfohlen mit Profil Industrie."
    }
  },
  "apm": {
  ...
  "yard-logistics": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Selten in der Public Edition.",
  ...
  "sustainability": {
    ...
    "nesteCenario": {
      "onprem": "Abgeschwächt.",
      "cloud": "Optional mit Profil Reguliert.",
  ...
  "document-compliance": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Aktiv. Peça do GROW honest minimum.",
      "rise": "Aktiv."
    }
  },
  "brim": {
    ...
    "nesteCenario": {
      ...
      "cloud": "Optional.",
      "rise": "Optional. Private Edition cabe BRIM pesado."
    }
  },
  "iot": {
  ...
  "cloud-alm": {
    ...
    "nesteCenario": {
      "onprem": "Disponível se houver Enterprise Support, mas the default é Solution Manager. Abgeschwächte Karte.",
  ...
  "solman": {
    ...
    "nesteCenario": {
      "onprem": "Main L6 card.",
      "cloud": "Ausgeblendet.",
      "rise": "Abgeschwächt. Default is Cloud ALM."
    }
  },
  "focused-run": {
  ...
  "dwc": {
    ...
    "nesteCenario": {
      "onprem": "Abgeschwächt. On-prem clássico deploys com SolMan/ChaRM — o contrário cultural do DwC.",
      "cloud": "Aktiv als Methode.",
      "rise": "Aktiv als Methode. Liga Signavio a Cloud ALM e a BTP."
    },
  ...
  "btc": {
    ...
    "nesteCenario": {
      ...
      "rise": "Empfohlen mit Profil Brownfield."
    }
  },
  "tricentis": {
  ...
  "sci": {
    "nome": "SAP Cloud Infrastruktur (SCI)",
    "tipo": "Souveräne IaaS",
    ...
    "nesteCenario": {
      "onprem": "Not applicable como host of the ERP on-prem. Abgeschwächte Karte.",
      "cloud": "Optional. Active when o selector L0 está em SCI ou o regulated profile está on. GROW/Public Edition pode ser publicado sobre SCI em regiões soberanas.",
  ...
  "cloud-erp": {
    ...
    "nesteCenario": {
      "onprem": "Nicht zutreffend.",
      "cloud": "Aktiv. Sinónimo comercial do Public Edition.",
      "rise": "Aktiv. Sinónimo comercial do Private Edition / RISE Cloud ERP."
    },
