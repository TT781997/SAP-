...
export const services: Record<string, ServiceCopy> = {
  "aws": {
    ...
    "nesteCenario": {
      "onprem": "Is not the host of the ERP. Pode existir como cloud satellite da empresa without fazer parte do core SAP. Dimmed card.",
  ...
  "gcp": {
    ...
    "nesteCenario": {
      "onprem": "Not the ERP host. Dimmed card.",
  ...
  "dc-onprem": {
    ...
    "nesteCenario": {
      "onprem": "L0 foundation card. The whole core sits here.",
  ...
  "cdc-option": {
    ...
    "nesteCenario": {
      "onprem": "Not applicable. On-prem clássico is not CDC.",
      "cloud": "Not applicable. GROW Public Edition não tem opção CDC.",
  ...
  "data-services": {
    ...
    "nesteCenario": {
      ...
      "rise": "Legacy. Visible with the toggle. Plano típico: phase-out to Datasphere + Suite."
    }
  },
  "data-intelligence": {
  ...
  "ai-foundation": {
    ...
    "nesteCenario": {
      "onprem": "Not applicable in the default mix.",
  ...
  "s4hana": {
    ...
    "nesteCenario": {
      "onprem": "Hidden. The active L4 card is s4-any ou ecc.",
  ...
  "cash-application": {
    ...
    "nesteCenario": {
      "onprem": "Dimmed.",
      "cloud": "Optional for Finance.",
      "rise": "Optional for Finance."
    }
  },
  "rar": {
  ...
  "fieldglass": {
    ...
    "nesteCenario": {
      "onprem": "Dimmed.",
      "cloud": "Optional; recommended with the external-workforce profile.",
      "rise": "Optional; recommended with the external-workforce profile."
    }
  },
  "taulia": {
    "nome": "SAP Taulia",
  ...
  "cloud-alm": {
    ...
    "nesteCenario": {
      "onprem": "Disponível se houver Enterprise Support, mas the default é Solution Manager. Dimmed card.",
  ...
  "dwc": {
    ...
    "nesteCenario": {
      ...
      "rise": "Active as a method. Liga Signavio a Cloud ALM e a BTP."
    },
  ...
  "sci": {
    ...
    "nesteCenario": {
      "onprem": "Not applicable como host of the ERP on-prem. Dimmed card.",
